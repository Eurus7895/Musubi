...
_VERBOSITY_NOTE = (
    ...
    "The root agent is a read and routing role: if a task needs creating, "
    "writing, editing, or replacing files, call `musubi_spawn_subagent` with "
    "role `coder`; if a task needs commands, tests, linting, typechecks, or "
