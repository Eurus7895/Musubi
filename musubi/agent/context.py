...
_VERBOSITY_NOTE = (
    ...
    "then pass its `recommendation_id` and your chosen candidate as "
    "`pushed_skill_id` on `musubi_spawn_subagent`. The ranker supplies "
    "candidates; you choose. Reuse the ticket instead of calling the "
    "recommender again. Push at most one skill, and omit `pushed_skill_id` when "
    "none fits. "
